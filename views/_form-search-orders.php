...
<form data-url="<?= $frm_search_url ?>" id="frm_search" action="/search-orders" method="GET" class="flex items-center w-full m-auto">
    <input name="query" type="text" class="w-3/4 dark:bg-zinc-200 rounded-3xl outline-none text-gray-900 px-4 py-2" placeholder="Search by id" oninput="search_orders()">
